...
// const foo = (value: unknown) => {
//   if (UpdateableTodo.is(value)) {
//     const bla = UpdateableTodo.to(value)
//     bla.
//   }
// }

// UpdateableTodo.toType

// UpdateableTodo.toType.is()
// const a = UpdateableTodo.from({
//   id: createId({ nanoIdLib: createNanoIdLib() }),
//   personJson: { name: "Joe", age: 32 },
// });

// if (a.ok) {
//   const b = UpdateableTodo.to(a.value);
//   console.log(b);
// }
