...
npm install @evolu/common@preview @evolu/react@preview @evolu/react-native@preview @op-engineering/op-sqlite react-native-quick-crypto react-native-quick-base64
```

```bash {{ title: 'Expo' }}
npm install @evolu/common@preview @evolu/react@preview @evolu/react-native@preview expo-sqlite react-native-quick-crypto react-native-quick-base64
```
...
const evolu = createEvolu(evoluReactWebDeps)(Schema, {
  name: SimpleName.fromOrThrow("your-app-name"),
