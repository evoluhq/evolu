...
Owners are cryptographically derived from a mnemonic (a list of 12 human-readable words) using SLIP-21 key derivation, ensuring secure and deterministic key generation:
