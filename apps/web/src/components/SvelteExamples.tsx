...
const examples = [
  {
    repo: "https://github.com/evoluhq/evolu/tree/main/examples/svelte-vite-pwa",
    name: "Vite + Svelte + PWA",
    description: "Offline support, installable on mobile.",
    logo: ViteLogo,
  },
  // TODO SvelteKit example
];

// TODO extract SvelteExamples List as Component, so that it can be used here and in the ReactExamples.tsx
export function SvelteExamples(): React.ReactElement {
  return (
