...
export const SocialLink = ({
  ...
  <Link href={href} target="_blank" className="group">
    ...
    <Icon className="h-5 w-5 fill-zinc-700 transition group-hover:fill-zinc-900 dark:fill-zinc-400 dark:group-hover:fill-zinc-100" />
  </Link>
);
...
const SmallPrint = () => (
  <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 sm:flex-row dark:border-white/5">
    <p className="text-xs text-zinc-600 dark:text-zinc-400">
      &copy; {new Date().getFullYear()} Evolu
    </p>
    <div className="flex gap-4">
      <SocialLink href="https://github.com/evoluhq/evolu" icon={GitHubIcon}>
        Follow us on GitHub
      </SocialLink>
      <SocialLink href="https://x.com/evoluhq" icon={XIcon}>
        Follow us on X
      </SocialLink>
      <SocialLink href="https://discord.gg/2J8yyyyxtZ" icon={DiscordIcon}>
