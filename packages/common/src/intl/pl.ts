...
export const formatByteSizeLiteralError: Type.TypeErrorFormatter<
...
export const formatDurationLiteralError: Type.TypeErrorFormatter<
...
export const formatPercentageLiteralError: Type.TypeErrorFormatter<
