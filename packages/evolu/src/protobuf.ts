...
class CrdtMessageContent$Type extends MessageType<CrdtMessageContent> {
    constructor() {
        super("CrdtMessageContent", [
            ...
            { no: 4, name: "stringValue", kind: "scalar", oneof: "value", T: 9 /*ScalarType.STRING*/ },
            { no: 5, name: "numberValue", kind: "scalar", oneof: "value", T: 5 /*ScalarType.INT32*/ }
        ]);
    }
}
/**
...
class SyncRequest$Type extends MessageType<SyncRequest> {
    constructor() {
        super("SyncRequest", [
            { no: 1, name: "messages", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => EncryptedCrdtMessage },
