...
### Define data and create React Hooks

To start using Evolu, define schemas for your database. Evolu uses [Schema](https://github.com/effect-ts/schema) for run-time validations.
...
### Show mnemonic protecting your data
